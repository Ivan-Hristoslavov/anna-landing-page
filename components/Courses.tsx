...
const courseData: CityGroup[] = [
  {
    ...
    courses: [
      ...
      },
      {
        ...
        badge: "3 дни",
        description:
          "Научете кода за авторския метод на  Анна и надградете уменията си в лимфен дренаж, миофасциални и  лифтинг техники, за да създавате реална трансформация за клиентите, и видими резултати, които те виждат, усещат и търсят отново и отново.",
      },
    ],
  },
  {
