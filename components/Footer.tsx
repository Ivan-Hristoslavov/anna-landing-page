  ...
  return (
    <footer className="bg-warm-900 text-warm-500">
      ...
      <div className="border-t border-warm-800 px-6 md:px-12 lg:px-24 pt-16 pb-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] gap-11 md:gap-14 md:items-start">
          {/* Brand */}
          <div className="md:justify-self-start md:pr-8">
            <p className="text-[10px] font-medium tracking-widest uppercase text-warm-600 mb-3">
              Анна
            </p>
            <h4 className="font-playfair text-xl font-light text-warm-100 mb-3 leading-snug xl:whitespace-nowrap">
              Професионални обучения в България
            </h4>
            <p className="text-xs font-light leading-relaxed text-warm-600 max-w-xs">
              Майсторски класове по миофасциален и лифтинг масаж на лице{" "}
            </p>
          </div>
            ...
            <ul className="space-y-3 text-xs text-warm-400 font-light">
              <li className="flex items-start gap-2">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  className="mt-0.5 shrink-0 text-warm-600"
                >
                  <path
                ...
                <span className="md:whitespace-nowrap">София, Варна — България</span>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  width="13"
      ...
      <div className="px-6 md:px-12 lg:px-24 py-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-3 text-[10px] text-warm-700 font-light tracking-wide">
          <p className="text-center md:text-left md:whitespace-nowrap">
            © {CURRENT_YEAR} Анна. Всички права запазени.
          </p>

          <div className="flex items-center justify-center gap-5 md:whitespace-nowrap">
            <a
              href="/privacy"
              className="hover:text-warm-400 transition-colors duration-200"
            >
              Поверителност
            </a>
          ...
          <p className="text-center md:text-right md:whitespace-nowrap">
            Разработено от{" "}
            <a
